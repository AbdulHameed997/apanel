...
(function ($) {
  ...
  var $compact_sidebar_checkbox = $('<input />', {
    ...
    .on('click', function () {
      if ($(this)
        .is(':checked')) {
        $('.nav-sidebar')
          .addClass('nav-compact')
      } else {
        $('.nav-sidebar')
          .removeClass('nav-compact')
      }
    })
  ...
  var $child_indent_sidebar_checkbox = $('<input />', {
    ...
    .on('click', function () {
      if ($(this)
        .is(':checked')) {
        $('.nav-sidebar')
          .addClass('nav-child-indent')
      } else {
        $('.nav-sidebar')
          .removeClass('nav-child-indent')
      }
    })
  ...
  var $no_expand_sidebar_checkbox = $('<input />', {
    ...
    .on('click', function () {
      if ($(this)
        .is(':checked')) {
        $('.main-sidebar')
          .addClass('sidebar-no-expand')
      } else {
        $('.main-sidebar')
          .removeClass('sidebar-no-expand')
      }
    })
  ...
  function createSkinBlock(colors, callback) {
    ...
    colors.map(function (color) {
      var $color = $('<div />', {
        'class': (typeof color === 'object' ? color.join(' ') : color).replace('navbar-', 'bg-')
