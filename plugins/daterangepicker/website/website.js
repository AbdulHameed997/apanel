  ...
  .ready(function () {
    ...
    function updateConfig() {
      ...
      if ($('#minYear')
        .val().length && $('#minYear')
        .val() != 1) {
        options.minYear = parseInt($('#minYear')
          .val(), 10)
      }
      ...
      if ($('#maxYear')
        .val().length && $('#maxYear')
        .val() != 1) {
        options.maxYear = parseInt($('#maxYear')
          .val(), 10)
      }
      ...
      if ($('#timePickerIncrement')
        .val().length && $('#timePickerIncrement')
        .val() != 1) {
        options.timePickerIncrement = parseInt($('#timePickerIncrement')
          .val(), 10)
      }
      ...
      if ($('#buttonClasses')
        .val().length && $('#buttonClasses')
        .val() != 'btn btn-sm') {
        options.buttonClasses = $('#buttonClasses')
          .val()
      }

      if ($('#applyButtonClasses')
        .val().length && $('#applyButtonClasses')
        .val() != 'btn-primary') {
        options.applyButtonClasses = $('#applyButtonClasses')
          .val()
      }

      if ($('#cancelButtonClasses')
        .val().length && $('#cancelButtonClasses')
        .val() != 'btn-default') {
        options.cancelClass = $('#cancelButtonClasses')
          .val()
      }
      ...
      $('#config-text')
        .val('$(\'#demo\').daterangepicker(' + option_text + ', function(start, end, label) {\n  console.log(\'New date range selected: \' + start.format(\'YYYY-MM-DD\') + \' to \' + end.format(\'YYYY-MM-DD\') + \' (predefined range: \' + label + \')\');\n});')
