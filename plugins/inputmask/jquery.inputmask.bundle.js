    ...
    function generateMaskSet(opts, nocache) {
      function generateMask(mask, metadata, opts) {
        ...
        var masksetDefinition,
          maskdefKey = regexMask ? 'regex_' + opts.regex : opts.numericInput ? mask.split('')
            .reverse()
            .join('') : mask
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function resolveTestFromToken(maskToken, ndxInitializer, loopNdx, quantifierRecurse) {
          function handleMatch(match, loopNdx, quantifierRecurse) {
              ...
              if (getMaskSet().tests[pos] || getMaskSet().validPositions[pos]) {
                $.each(getMaskSet().tests[pos] || [getMaskSet().validPositions[pos]], function (ndx, lmnt) {
                  ...
                  var alternation = targetAlternation !== undefined ? targetAlternation : lmnt.alternation,
                    ndxPos = lmnt.locator[alternation] !== undefined ? lmnt.locator[alternation].toString()
                      .indexOf(alternateNdx) : -1
            ...
            function isSubsetOf(source, target) {
              ...
              if (opts.regex && source.match.fn !== null && target.match.fn !== null) {
                return expand(target.match.def.replace(/[\[\]]/g, ''))
                  .indexOf(expand(source.match.def.replace(/[\[\]]/g, ''))) !== -1
              }
              return source.match.def === target.match.nativeDef
            }

            function staticCanMatchDefinition(source, target) {
              var sloc = source.locator.slice(source.alternation)
                  .join(''),
                tloc = target.locator.slice(target.alternation)
                  .join(''),
                canMatch = sloc == tloc
            ...
            function setMergeLocators(targetMatch, altMatch) {
              if (altMatch === undefined || targetMatch.alternation === altMatch.alternation && targetMatch.locator[targetMatch.alternation].toString()
                ...
                if (locNdx === undefined) {
                  ...
                  if (altMatch !== undefined) {
                    ...
                    targetMatch.locator[targetMatch.alternation] = Object.keys(targetMatch.mloc)
                      .join(',')
                  }
                  return true
                }
                ...
                if (tst.def !== '') {
                  if (locator.length === 0) {
                    ...
                    for (var i = 0; i < locator.length; i++) {
                      if (tst.locator[i] && locator[i].toString()
                        .indexOf(tst.locator[i]) === -1) {
        ...
        if (ie) {
          if (npt.inputmask._valueGet() !== value && (npt.placeholder !== value || npt.placeholder === '')) {
            ...
            if (nptValue !== value) {
              ...
              if (lvp === -1 && nptValue === getBufferTemplate()
                .join('')) {
                buffer = []
              } else if (lvp !== -1) {
      ...
      var EventHandlers = {
        keydownEvent: function keydownEvent(e) {
          ...
          if (k === Inputmask.keyCode.BACKSPACE || k === Inputmask.keyCode.DELETE || iphone && k === Inputmask.keyCode.BACKSPACE_SAFARI || e.ctrlKey && k === Inputmask.keyCode.X && !isInputEventSupported('cut')) {
            ...
            writeBuffer(input, getBuffer(true), getMaskSet().p, e, input.inputmask._valueGet() !== getBuffer()
              .join(''))
        ...
        keypressEvent: function keypressEvent(e, checkval, writeOut, strict, ndx) {
          ...
          if (checkval !== true && !(e.ctrlKey && e.altKey) && (e.ctrlKey || e.metaKey || ignorable)) {
            if (k === Inputmask.keyCode.ENTER && undoValue !== getBuffer()
              .join('')) {
              undoValue = getBuffer()
                .join('')
              setTimeout(function () {
        ...
        pasteEvent: function pasteEvent(e) {
          ...
          if (valueBeforeCaret === (isRTL ? getBufferTemplate()
            .reverse() : getBufferTemplate()).slice(0, caretPos.begin)
            .join('')) {
            valueBeforeCaret = ''
          }
          if (valueAfterCaret === (isRTL ? getBufferTemplate()
            .reverse() : getBufferTemplate()).slice(caretPos.end)
            .join('')) {
            valueAfterCaret = ''
          }
          ...
          checkVal(input, false, false, pasteValue.toString()
            .split(''))
          writeBuffer(input, getBuffer(), seekNext(getLastValidPosition()), e, undoValue !== getBuffer()
            .join(''))
          return e.preventDefault()
        },
        inputFallBackEvent: function inputFallBackEvent(e) {
          ...
          function ieMobileHandler(input, inputValue, caretPos) {
            if (iemobile) {
              var inputChar = inputValue.replace(getBuffer()
                .join(''), '')
        ...
        setValueEvent: function setValueEvent(e) {
          ...
          undoValue = getBuffer()
            .join('')
          if ((opts.clearMaskOnLostFocus || opts.clearIncomplete) && input.inputmask._valueGet() === getBufferTemplate()
            .join('')) {
        ...
        cutEvent: function cutEvent(e) {
          ...
          var clipboardData = window.clipboardData || ev.clipboardData,
            clipData = isRTL ? getBuffer()
              .slice(pos.end, pos.begin) : getBuffer()
              .slice(pos.begin, pos.end)
          clipboardData.setData('text', isRTL ? clipData.reverse()
            .join('') : clipData.join(''))
          if (document.execCommand) {
            document.execCommand('copy')
          }
          handleRemove(input, Inputmask.keyCode.DELETE, pos)
          writeBuffer(input, getBuffer(), getMaskSet().p, e, undoValue !== getBuffer()
            .join(''))
        },
          ...
          if (input.inputmask) {
            ...
            if (nptValue !== '' || colorMask !== undefined) {
              if (opts.clearMaskOnLostFocus) {
                if (getLastValidPosition() === -1 && nptValue === getBufferTemplate()
                  .join('')) {
                  buffer = []
                } else {
                  clearOptionalTail(buffer)
        ...
        mouseenterEvent: function mouseenterEvent(e) {
          ...
          if (document.activeElement !== input && opts.showMaskOnHover) {
            HandleNativePlaceholder(input, (isRTL ? getBuffer()
              .slice()
              .reverse() : getBuffer()).join(''))
          }
        },
        submitEvent: function submitEvent(e) {
          ...
          if (opts.clearMaskOnLostFocus && getLastValidPosition() === -1 && el.inputmask._valueGet && el.inputmask._valueGet() === getBufferTemplate()
            .join('')) {
      ...
      function unmaskedvalue(input) {
        ...
        if ($.isFunction(opts.onUnMask)) {
          var bufferValue = (isRTL ? getBuffer()
            .slice()
            .reverse() : getBuffer()).join('')
      ...
      function determineLastRequiredPosition(returnDefinition) {
        ...
        for (pos = bl - 1; pos > lvp; pos--) {
          ...
          if ((testPos.match.optionality || testPos.match.optionalQuantifier && testPos.match.newBlockMarker || lvTestAlt && (lvTestAlt !== positions[pos].locator[lvTest.alternation] && testPos.match.fn != null || testPos.match.fn === null && testPos.locator[lvTest.alternation] && checkAlternationMatch(testPos.locator[lvTest.alternation].toString()
            .split(','), lvTestAlt.toString()
            .split(',')) && getTests(pos)[0].def !== '')) && buffer[pos] === getPlaceholder(pos, testPos.match)) {
            bl--
          } else {
            break
          }
      ...
      function mask(elem) {
        function isElementTypeSupported(input, opts) {
          function patchValueProperty(npt) {
            ...
            function getter() {
              if (this.inputmask) {
                return this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : getLastValidPosition() !== -1 || opts.nullable !== true ? document.activeElement === this && opts.clearMaskOnLostFocus ? (isRTL ? clearOptionalTail(getBuffer()
                  .slice())
                  .reverse() : clearOptionalTail(getBuffer()
                  .slice())).join('') : valueGet.call(this) : ''
              } else {
            ...
            if (!npt.inputmask.__valueGet) {
              ...
              npt.inputmask._valueGet = function (overruleRTL) {
                return isRTL && overruleRTL !== true ? valueGet.call(this.el)
                  .split('')
                  .reverse()
                  .join('') : valueGet.call(this.el)
              }
              npt.inputmask._valueSet = function (value, overruleRTL) {
                valueSet.call(this.el, value === null || value === undefined ? '' : overruleRTL !== true && isRTL ? value.split('')
                  .reverse()
                  .join('') : value)
              }
      ...
      if (actionObj !== undefined) {
        switch (actionObj.action) {
          ...
          case 'isValid':
            ...
            return isComplete(buffer) && actionObj.value === getBuffer()
              .join('')
          ...
          case 'getmetadata':
            if ($.isArray(maskset.metadata)) {
              var maskTarget = getMaskTemplate(true, 0, false)
                .join('')
    ...
    function analyseMask(maskString, format, opts) {
      ...
      function extendProperty(value) {
        ...
        if (correctedValue != value) {
          ...
          correctedValue = enteredPart + (enteredPart < min.slice(0, enteredPart.length) ? min.slice(enteredPart.length) : enteredPart > max.slice(0, enteredPart.length) ? max.slice(enteredPart.length) : correctedValue.toString()
    ...
    Inputmask.extendAliases({
      numeric: {
        ...
        postValidation: function postValidation(buffer, pos, currentResult, opts) {
          ...
          prefix = prefix.join('')
          suffix = suffix.join('')
          var processValue = maskedValue.join('')
            .replace(prefix, '')
        ...
        isComplete: function isComplete(buffer, opts) {
          var maskedValue = (opts.numericInput ? buffer.slice()
            .reverse() : buffer).join('')
        ...
        onBeforeMask: function onBeforeMask(initialValue, opts) {
          ...
          return alignDigits(initialValue.toString()
            .split(''), digits, opts)
            .join('')
        },
        onKeyDown: function onKeyDown(e, buffer, caretPos, opts) {
    ...
    if ($.fn.inputmask === undefined) {
      $.fn.inputmask = function (fn, options) {
        ...
        if (typeof fn === "string") {
          switch (fn) {
            case "unmaskedvalue":
              return input && input.inputmask ? input.inputmask.unmaskedvalue() : $(input)
                .val();
