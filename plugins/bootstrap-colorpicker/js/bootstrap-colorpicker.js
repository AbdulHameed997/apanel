        ...
        var Debugger = function (_Extension) {
          ...
          _createClass(Debugger, [{
            ...
            value: function onCreate(event) {
              ...
              return _get(Debugger.prototype.__proto__ || Object.getPrototypeOf(Debugger.prototype), 'onCreate', this)
                .call(this, event)
            }
          }, {
            key: 'onDestroy',
            value: function onDestroy(event) {
              ...
              return _get(Debugger.prototype.__proto__ || Object.getPrototypeOf(Debugger.prototype), 'onDestroy', this)
                .call(this, event)
            }
          }, {
            key: 'onUpdate',
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var Preview = function (_Extension) {
          ...
          _createClass(Preview, [{
            key: 'onCreate',
            value: function onCreate(event) {
              _get(Preview.prototype.__proto__ || Object.getPrototypeOf(Preview.prototype), 'onCreate', this)
                .call(this, event)
            ...
            key: 'onUpdate',
            value: function onUpdate(event) {
              _get(Preview.prototype.__proto__ || Object.getPrototypeOf(Preview.prototype), 'onUpdate', this)
                .call(this, event)

              if (!event.color) {
                this.elementInner.css('backgroundColor', null)
                  .css('color', null)
                  .html('')
                return
              }
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        var Swatches = function (_Palette) {
          ...
          _createClass(Swatches, [{
            ...
            key: 'onCreate',
            value: function onCreate(event) {
              _get(Swatches.prototype.__proto__ || Object.getPrototypeOf(Swatches.prototype), 'onCreate', this)
                .call(this, event)
            ...
            value: function load() {
              ...
              _jquery2.default.each(this.colors, function (name, value) {
                var $swatch = (0, _jquery2.default)(_this2.options.swatchTemplate)
                  .attr('data-name', name)
                  .attr('data-value', value)
                  .attr('title', isAliased ? name + ': ' + value : value)
                  .on('mousedown.colorpicker touchstart.colorpicker', function (e) {
          ...
          _createClass(SliderHandler, [{
            ...
            value: function bind() {
              ...
              this.colorpicker.picker.find(sliderClasses.join(', '))
                .on('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.pressed, this))
            }
            ...
            value: function pressed(e) {
              ...
              var guide = zone.find('.colorpicker-guide')
                .get(0)
        ...
        var PopupHandler = function () {
          ...
          _createClass(PopupHandler, [{
            ...
            value: function bind() {
              ...
              (0, _jquery2.default)(this.root)
                .on('resize.colorpicker', _jquery2.default.proxy(this.reposition, this))
            }
            ...
            value: function unbind() {
              ...
              (0, _jquery2.default)(this.root)
                .off('resize.colorpicker', _jquery2.default.proxy(this.reposition, this));
              (0, _jquery2.default)(this.root.document)
                .off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.hide, this));
              (0, _jquery2.default)(this.root.document)
                .off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.onClickingInside, this))
            }
          }, {
            ...
            value: function createPopover() {
              ...
              this.popoverTip = (0, _jquery2.default)(this.popoverTarget.popover('getTipElement')
                .data('bs.popover').tip)
            ...
            value: function show(e) {
              ...
              cp.picker.addClass('colorpicker-visible')
            ...
            value: function fireShow() {
              ...
              if (this.isPopover) {
                ...
                (0, _jquery2.default)(this.root.document)
                  .on('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.hide, this));
                (0, _jquery2.default)(this.root.document)
                  .on('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.onClickingInside, this))
              }
      ...
      /***/ (function (module, exports, __webpack_require__) {
        ...
        Object.keys(convert)
          .forEach(function (model) {
            hashedModelKeys[_slice.call(convert[model].labels)
              .sort()
              .join('')] = model
          })
        ...
        Color.prototype = {
          ...
          percentString: function (places) {
            var self = this.rgb()
              .round(typeof places === 'number' ? places : 1)
            var args = self.valpha === 1 ? self.color : self.color.concat(this.valpha)
          ...
          hex: function (val) {
            ...
            return colorString.to.hex(this.rgb()
              .round().color)
          },
        ...
        Object.keys(convert)
          .forEach(function (model) {
            ...
            Color.prototype[model] = function () {
              ...
              return new Color(assertArray(convert[this.model][model].raw(this.color))
                .concat(newAlpha), model)
            }
...
// create a list of reverse color names
        ...
        cs.get = function (string) {
          var prefix = string.substring(0, 3)
            .toLowerCase()
          var val
          var model
          switch (prefix) {
          ...
          _createClass(PickerHandler, [{
            ...
            value: function update() {
              ...
              this.picker.find('.colorpicker-saturation')
                .css('backgroundColor', this.color.getCloneHueOnly()
              ...
              this.picker.find('.colorpicker-alpha-color')
