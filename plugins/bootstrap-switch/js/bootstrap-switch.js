...
(function (global, factory) {
  ...
  function prvwidth() {
    ...
    var $handles = this.$on.add(this.$off)
      .add(this.$label)
      .css('width', '')
  ...
  function prvelementHandlers() {
    ...
    return this.$element.on({
      ...
      'previousState.bootstrapSwitch': function previousStateBootstrapSwitch() {
        ...
        _this4.$element.prop('checked', _this4.options.state)
      ...
      'change.bootstrapSwitch': function changeBootstrapSwitch(event, skip) {
        ...
        _this4.$wrapper.toggleClass(prvgetClass.call(_this4, 'off'))
  ...
  var BootstrapSwitch = function () {
    function BootstrapSwitch(element) {
      ...
      this.$wrapper = $('<div>', {
        class: function _class() {
          return getClasses(_this9.options, _this9.$element.attr('id'))
            .map(function (v) {
              return prvgetClass.call(_this9, v)
            })
            .concat([_this9.options.baseClass], prvgetClasses.call(_this9, _this9.options.wrapperClass))
            .join(' ')
        }
      })
      ...
      this.$container = this.$element.wrap(this.$container)
        .parent()
      this.$wrapper = this.$container.wrap(this.$wrapper)
        .parent()
      this.$element.before(this.options.inverse ? this.$off : this.$on)
        .before(this.$label)
    ...
    _createClass(BootstrapSwitch, [{
      ...
      value: function wrapperClass(value) {
        ...
        this.$wrapper.removeClass(prvgetClasses.call(this, this.options.wrapperClass)
          .join(' '))
        this.$wrapper.addClass(prvgetClasses.call(this, wrapperClass)
          .join(' '))
      ...
      value: function destroy() {
        var $form = this.$element.closest('form')
        if ($form.length) {
          $form.off('reset.bootstrapSwitch')
