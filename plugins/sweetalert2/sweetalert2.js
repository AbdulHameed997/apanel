...
(function (global, factory) {
  ...
  var warn = function warn(message) {
    console.warn(''.concat(consolePrefix, ' ')
      .concat(message))
  }
  /**
  ...
  var error = function error(message) {
    console.error(''.concat(consolePrefix, ' ')
      .concat(message))
  }
  /**
  ...
  var warnAboutDepreation = function warnAboutDepreation(deprecatedParam, useInstead) {
    warnOnce('"'.concat(deprecatedParam, '" is deprecated and will be removed in the next major release. Please use "')
      ...
      default:
        ['title', 'html', 'type'].forEach(function (name, index) {
          switch (_typeof(args[index])) {
            ...
            default:
              error('Unexpected type of '.concat(name, '! Expected "string", got ')
  ...
  var removeCustomClasses = function removeCustomClasses(elem) {
    toArray(elem.classList)
      .forEach(function (className) {
        if (!(objectValues(swalClasses)
          .indexOf(className) !== -1) && !(objectValues(iconTypes)
          .indexOf(className) !== -1)) {
  ...
  var applyCustomClass = function applyCustomClass(elem, customClass, className) {
    ...
    if (customClass && customClass[className]) {
      if (typeof customClass[className] !== 'string' && !customClass[className].forEach) {
        return warn('Invalid type of customClass.'.concat(className, '! Expected string or iterable object, got "')
  ...
  var getFocusableElements = function getFocusableElements() {
    var focusableElementsWithTabindex = toArray(getPopup()
      .querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')) // sort according to tabindex
      .sort(function (a, b) {
    ...
    var otherFocusableElements = toArray(getPopup()
...
// Detect Node env
  ...
  var sweetHTML = '\n <div aria-labelledby="'.concat(swalClasses.title, '" aria-describedby="')
...
// https://github.com/twbs/bootstrap/blob/master/js/modal.js#L279-L286
  ...
  function handleButtonsStyling(confirmButton, cancelButton, params) {
    ...
    var confirmButtonBackgroundColor = window.getComputedStyle(confirmButton)
  ...
  var renderContent = function renderContent(instance, params) {
    var content = getContent()
      .querySelector('#' + swalClasses.content) // Content as HTML
  ...
  var renderIcon = function renderIcon(instance, params) {
    ...
    if (Object.keys(iconTypes)
      .indexOf(params.type) !== -1) {
      var icon = elementBySelector('.'.concat(swalClasses.icon, '.')
  ...
  var adjustSuccessIconBackgoundColor = function adjustSuccessIconBackgoundColor() {
    var popup = getPopup()
    var popupBackgroundColor = window.getComputedStyle(popup)
      .getPropertyValue('background-color')
  ...
  var clickConfirm = function clickConfirm() {
    return getConfirmButton() && getConfirmButton()
      .click()
  }
  /*
  ...
  var clickCancel = function clickCancel() {
    return getCancelButton() && getCancelButton()
      .click()
  }
    ...
    var MixinSwal =
      ...
      function (_this) {
        ...
        function MixinSwal() {
          ...
          return _possibleConstructorReturn(this, _getPrototypeOf(MixinSwal)
        ...
        _createClass(MixinSwal, [{
          ...
          value: function _main(params) {
            return _get(_getPrototypeOf(MixinSwal.prototype), '_main', this)
...
// private global state for the queue feature
  ...
  var fixScrollbar = function fixScrollbar() {
    ...
    if (document.body.scrollHeight > window.innerHeight) {
      ...
      states.previousBodyPadding = parseInt(window.getComputedStyle(document.body)
...
// reader’s list of elements (headings, form controls, landmarks, etc.) in the document.
  ...
  function setDefaultInputValidators(params) {
    ...
    if (!params.inputValidator) {
      Object.keys(defaultInputValidators)
  ...
  var confirm = function confirm(instance, innerParams, value) {
    ...
    if (innerParams.preConfirm) {
      ...
      var preConfirmPromise = Promise.resolve()
        .then(function () {
