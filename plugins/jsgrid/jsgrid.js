...
(function (window, $, undefined) {
  ...
  Grid.prototype = {
    ...
    rowClick: function (args) {
      if (this.editing) {
        this.editItem($(args.event.target)
          .closest('tr'))
      }
    },
    rowDoubleClick: $.noop,
    ...
    invalidNotify: function (args) {
      ...
      window.alert([this.invalidMessage].concat(messages)
        .join('\n'))
    },
    ...
    _attachWindowLoadResize: function () {
      $(window)
        .on('load', $.proxy(this._refreshSize, this))
    },

    _attachWindowResizeCallback: function () {
      if (this.updateOnResize) {
        $(window)
          .on('resize', $.proxy(this._refreshSize, this))
      }
    },

    _detachWindowResizeCallback: function () {
      $(window)
        .off('resize', this._refreshSize)
    },
    ...
    render: function () {
      this._renderGrid()
      return this.autoload ? this.loadData() : $.Deferred()
        .resolve()
        .promise()
    },
    ...
    _createPagerContainer: function () {
      var pagerContainer = this.pagerContainer || $('<div>')
        .appendTo(this._container)
      return $(pagerContainer)
        .addClass(this.pagerContainerClass)
    },
    ...
    _createCell: function (item, field) {
      ...
      if ($.isFunction(field.cellRenderer)) {
        ...
        $result = $('<td>')
          .append(this.renderTemplate(field.itemTemplate || fieldValue, field, args))
      }
    ...
    _validateItem: function (item, $row) {
      ...
      this._eachField(function (field) {
        ...
        this._setCellValidity($row.children()
          .eq(this._visibleFieldIndex(field)), errors)
    ...
    _createEditRow: function (item) {
      ...
      this._eachField(function (field) {
        ...
        this._prepareCell('<td>', field, 'editcss')
          .append(this.renderTemplate(field.editTemplate || '', field, {
            value: fieldValue,
            item: item
          }))
          .appendTo($result)
...
(function (jsGrid, $, undefined) {
  ...
  ControlField.prototype = new Field({
    ...
    editTemplate: function () {
      return this._createUpdateButton()
        .add(this._createCancelEditButton())
    },
