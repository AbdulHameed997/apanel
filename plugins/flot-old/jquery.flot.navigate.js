...
(function (a) {
  function e(h) {
    ...
    } else if (d.dragging || l.which > 0 && h.which != l.which || a(h.target)
      .is(l.not)) {
      return
    }
    switch (h.type) {
      case'mousedown':
        return a.extend(l, a(j)
          .offset(), {
          elem: j,
          target: h.target,
          pageX: h.pageX,
