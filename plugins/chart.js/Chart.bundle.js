...
// DEPRECATIONS
  ...
  function listenArrayEvents(array, listener) {
    ...
    arrayEvents.forEach(function (key) {
      var method = 'onData' + key.charAt(0)
  ...
  helpers$1.extend(DatasetController.prototype, {
    ...
    _resolveDatasetElementOptions: function (element, hover) {
      ...
      for (i = 0, ilen = elementOptions.length; i < ilen; ++i) {
        ...
        readKey = hover ? 'hover' + key.charAt(0)
...
// Helper to push or concat based on if the 2nd parameter is an array or not
  ...
  helpers$1.extend(Chart.prototype, /** @lends Chart */ {
    ...
    buildOrUpdateScales: function () {
      ...
      var items = []
      var updated = Object.keys(scales)
    ...
    resetElements: function () {
      ...
      helpers$1.each(me.data.datasets, function (dataset, datasetIndex) {
        me.getDatasetMeta(datasetIndex)
          .controller
          .reset()
      }, me)
    },
...
// DEPRECATIONS
  ...
  var scale_category = core_scale.extend({
    ...
    getLabelForIndex: function (index, datasetIndex) {
      ...
      if (chart.getDatasetMeta(datasetIndex)
        .controller
        ._getValueScaleId() === me.id) {
  ...
  var scale_time = core_scale.extend({
    ...
    determineDataLimits: function () {
      ...
      if (timestamps.length) {
        timestamps = ilen > 1 ? arrayUnique(timestamps)
          .sort(sorter) : timestamps.sort(sorter)
    ...
    (function (global, factory) {
      ...
      function firstWeekOffset(year, dow, doy) {
        var // first-week day -- which january is always in the first week (4 for iso, 1 for other)
          ...
          fwdlw = (7 + createUTCDate(year, 0, fwd)
            .getUTCDay() - dow) % 7
      ...
      function cloneWithOffset(input, model) {
        ...
        if (model._isUTC) {
          res = model.clone()
          diff = (isMoment(input) || isDate(input) ? input.valueOf() : createLocal(input)
            .valueOf()) - res.valueOf()
      ...
      function positiveMomentsDifference(base, other) {
        ...
        res.milliseconds = +other - +(base.clone()
          .add(res.months, 'M'))
      ...
      function calendar$1(time, formats) {
        ...
        var now = time || createLocal(),
          sod = cloneWithOffset(now, this)
            .startOf('day'),
          format = hooks.calendarFormat(this, sod) || 'sameElse'

        var output = formats && (isFunction(formats[format]) ? formats[format].call(this, now) : formats[format])

        return this.format(output || this.localeData()
          .calendar(format, this, createLocal(now)))
      }
      ...
      function isAfter(input, units) {
        ...
        if (units === 'millisecond') {
          ...
          return localInput.valueOf() < this.clone()
            .startOf(units)
            .valueOf()
        }
      }
      ...
      function isSame(input, units) {
        ...
        if (units === 'millisecond') {
          ...
          return this.clone()
            .startOf(units)
            .valueOf() <= inputMs && inputMs <= this.clone()
            .endOf(units)
            .valueOf()
        }
      }
      ...
      function getSetDayOfYear(input) {
        var dayOfYear = Math.round((this.clone()
      ...
      function relativeTime$1(posNegDuration, withoutSuffix, locale) {
        var duration = createDuration(posNegDuration)
          .abs()
      ...
      function toISOString$1() {
        ...
        var h = hours
        var m = minutes
        var s = seconds ? seconds.toFixed(3)
          .replace(/\.?0+$/, '') : ''
