    ...
    _classes: function (options) {
      ...
      function processClassString(classes, checkOption) {
        ...
        for (i = 0; i < classes.length; i++) {
          ...
          if (options.add) {
            current = $($.unique(current.get()
              .concat(options.element.get())))
          } else {
            current = $(current.not(options.element)
              .get())
          }
    ...
    _untrackClassesElement: function (event) {
      ...
      $.each(that.classesElementLookup, function (key, value) {
        if ($.inArray(event.target, value) !== -1) {
          that.classesElementLookup[key] = $(value.not(event.target)
            .get())
        }
      })
    },
  ...
  (function () {
    ...
    if ($.expr && $.expr.filters && $.expr.filters.animated) {
      $.expr.filters.animated = (function (orig) {
        return function (elem) {
          return !!$(elem)
            .data(dataSpaceAnimated) || orig(elem)
        }
...
//>>css.theme: ../../themes/base/theme.css
  ...
  var widgetsMenu = $.widget('ui.menu', {
    ...
    _create: function () {
      ...
      this._on({
        ...
        'mouseenter .ui-menu-item': function (event) {
          ...
          this._removeClass(target.siblings()
        ...
        focus: function (event, keepActiveItem) {
          ...
          var item = this.active || this.element.find(this.options.items)
            .eq(0)
    ...
    refresh: function () {
      ...
      items.filter('.ui-state-disabled')
    ...
    select: function (event) {
      ...
      this.active = this.active || $(event.target)
        .closest('.ui-menu-item')
...
//>>css.theme: ../../themes/base/theme.css
  ...
  $.widget('ui.checkboxradio', [$.ui.formResetMixin, {
    ...
    _updateLabel: function () {
      ...
      var contents = this.label.contents()
        .not(this.element[0])
      if (this.icon) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _checkOffset: function (inst, offset, isFixed) {
      var dpWidth = inst.dpDiv.outerWidth(),
        ...
        viewWidth = document.documentElement.clientWidth + (isFixed ? 0 : $(document)
          .scrollLeft()),
        viewHeight = document.documentElement.clientHeight + (isFixed ? 0 : $(document)
          .scrollTop())

      offset.left -= (this._get(inst, 'isRTL') ? (dpWidth - inputWidth) : 0)
      offset.left -= (isFixed && offset.left === inst.input.offset().left) ? $(document)
        .scrollLeft() : 0
      offset.top -= (isFixed && offset.top === (inst.input.offset().top + inputHeight)) ? $(document)
        .scrollTop() : 0
    ...
    _selectDay: function (id, month, year, td) {
      ...
      if ($(td)
        .hasClass(this._unselectableClass) || this._isDisabledDatepicker(target[0])) {
        return
      }
    ...
    _attachHandlers: function (inst) {
      ...
      inst.dpDiv.find('[data-handler]')
        .map(function () {
          ...
          $(this)
            .on(this.getAttribute('data-event'), handler[this.getAttribute('data-handler')])
        })
    },
    ...
    _getDaysInMonth: function (year, month) {
      return 32 - this._daylightSavingAdjust(new Date(year, month, 32))
        .getDate()
    },
 ...
 */
  ...
  $.fn.datepicker = function (options) {
    ...
    if (!$.datepicker.initialized) {
      $(document)
        .on('mousedown', $.datepicker._checkExternalClick)
  ...
  $.widget('ui.draggable', $.ui.mouse, {
    ...
    _setContainment: function () {
      ...
      if (o.containment === 'window') {
        this.containment = [
          $(window)
            .scrollLeft() - this.offset.relative.left - this.offset.parent.left,
          $(window)
  ...
  $.widget('ui.resizable', $.ui.mouse, {
    ...
    _mouseStart: function (event) {
      ...
      cursor = $('.ui-resizable-' + this.axis)
        .css('cursor')
      $('body')
        .css('cursor', cursor === 'auto' ? this.axis + '-resize' : cursor)
      ...
      $.each($.ui.ddmanager.droppables[draggable.options.scope] || [], function () {
        ...
        if (this.options.greedy) {
          ...
          parent = this.element.parents(':data(ui-droppable)')
            .filter(function () {
              return $(this)
                .droppable('instance').options.scope === scope
            })
  ...
  var widgetsSelectable = $.widget('ui.selectable', $.ui.mouse, {
    ...
    _create: function () {
      ...
      this.refresh = function () {
        that.elementPos = $(that.element[0])
          .offset()
    ...
    _mouseStart: function (event) {
      ...
      this.elementPos = $(this.element[0])
        .offset()
      ...
      this.selectees.filter('.ui-selected')
        .each(function () {
...
//>>css.theme: ../../themes/base/theme.css
  ...
  var widgetsSelectmenu = $.widget('ui.selectmenu', [$.ui.formResetMixin, {
    ...
    _move: function (direction, event) {
      ...
      if (direction === 'first' || direction === 'last') {
        next = item[direction === 'first' ? 'prevAll' : 'nextAll'](filter)
          .eq(-1)
      } else {
    ...
    _refreshValue: function () {
      ...
      if (this._hasMultipleValues()) {
        this.handles.each(function (i) {
          ...
          $(this)
            .stop(1, 1)[animate ? 'animate' : 'css'](_set, o.animate)
...
//>>css.theme: ../../themes/base/theme.css
  ...
  $.widget('ui.spinner', {
    ...
    _setOption: function (key, value) {
      ...
      if (key === 'icons') {
        first = this.buttons.first()
          .find('.ui-icon')
        this._removeClass(first, null, this.options.icons.up)
        this._addClass(first, null, value.up)
        last = this.buttons.last()
          .find('.ui-icon')
...
//>>css.theme: ../../themes/base/theme.css
  ...
  $.widget('ui.tabs', {
    ...
    _tabKeydown: function (event) {
      var focusedTab = $($.ui.safeActiveElement(this.document[0]))
          .closest('li'),
...
//>>css.theme: ../../themes/base/theme.css
  ...
  $.widget('ui.tooltip', {
    ...
    _open: function (event, target, content) {
      ...
      if (tooltipData) {
        tooltipData.tooltip.find('.ui-tooltip-content')
          .html(content)
        return
      }
      ...
      tooltip.find('.ui-tooltip-content')
        .html(content)
      ...
      this.liveRegion.children()
        .hide()
      a11yContent = $('<div>')
        .html(tooltip.find('.ui-tooltip-content')
          .html())
      a11yContent.removeAttr('name')
        .find('[name]')
        .removeAttr('name')
      a11yContent.removeAttr('id')
        .find('[id]')
        .removeAttr('id')
