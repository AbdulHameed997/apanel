...
declare module '@fullcalendar/core' {
  ...
  export {
    intersectRects, Rect, pointInsideRect, constrainPoint, getRectCenter, diffPoints, Point, translateRect
  } from '@fullcalendar/core/util/geom';
  ...
  export {
    ...
    elementClosest,
    forceClassName
  } from '@fullcalendar/core/util/dom-manip';
  export {
    EventStore,
    ...
    getRelevantEvents,
    eventTupleToStore
  } from '@fullcalendar/core/structs/event-store';
  ...
  export {
    computeInnerRect, computeEdges, computeHeightAndMargins, getClippingParents, computeClippingRect, computeRect
  } from '@fullcalendar/core/util/dom-geom';
  ...
  } from '@fullcalendar/core/datelib/date-range';
  ...
  } from '@fullcalendar/core/common/scroll-controller';
  ...
  export {
    default as Calendar, DatePointTransform, DateSpanTransform, DateSelectionApi
  ...
  export {
    ...
    diffDays,
    isValidDate
  } from '@fullcalendar/core/datelib/marker';
  export {
    Duration,
    createDuration,
    isSingleDay,
  ...
  } from '@fullcalendar/core/datelib/duration';
  export {DateEnv, DateMarkerMeta} from '@fullcalendar/core/datelib/env';
  export {
    DateFormatter, createFormatter, VerboseFormattingArg, formatIsoTimeString
  ...
  export {
    ...
    InteractionSettingsStore
  } from '@fullcalendar/core/interactions/interaction';
  ...
  export {
    createPlugin, PluginDef, PluginDefInput, ViewPropsTransformer, ViewContainerModifier
  } from '@fullcalendar/core/plugin-system';
  ...
  export {
    EventRenderRange, sliceEventStore, hasBgRendering, getElSeg
  } from '@fullcalendar/core/component/event-rendering';
  ...
  export {
    Constraint, ConstraintInput, AllowFunc, isPropsValid, isInteractionValid
  } from '@fullcalendar/core/validation';
