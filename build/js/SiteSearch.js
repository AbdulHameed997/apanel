...
const SiteSearch = (($) => {
  ...
  class SiteSearch {
    ...
    open() {
      $(Selector.SEARCH_BLOCK)
        .slideDown(this.options.transitionSpeed)
      $(Selector.SEARCH_BACKDROP)
        .show(0)
    ...
    close() {
      $(Selector.SEARCH_BLOCK)
        .slideUp(this.options.transitionSpeed)
      $(Selector.SEARCH_BACKDROP)
        .hide(0)
      $(Selector.SEARCH_BLOCK)
   ...
   */
  $(document)
    .on('click', Selector.TOGGLE_BUTTON, (event) => {
  ...
  $(document)
    .on('click', Selector.SEARCH_BACKDROP, (event) => {
